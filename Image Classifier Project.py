...
# The main goal is to return the setup model, the criterion and the optimizer for Training
# Architectures: vgg16, densenet121, alexnet
# Further arguments are: network hyperparameters(dropout, hidden_layer1 nodes, learning rate) and wather it should use GPU
...
def check_accuracy_on_test(testloader):
    ...
    print("Network accuracy durring test: %d %%" % (100* correct / total))
